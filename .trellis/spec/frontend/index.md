...
- The iframe behavior lives in compiled TypeScript under `src/iframe/`
- The page calls shared runtime/controller logic directly instead of going through a message-bus bridge
...
| [State Management](./state-management.md)         | Hand-written iframe state and direct runtime flow | Complete |
