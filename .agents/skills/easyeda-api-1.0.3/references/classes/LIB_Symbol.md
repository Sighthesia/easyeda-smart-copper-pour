...
Promise&lt;[ILIB_SymbolItem](../interfaces/ILIB_SymbolItem.md) \| undefined&gt;

符号属性

### modify

# LIB_Symbol.modify() method
...
_（可选）_ 分屏 ID，不填写则默认在最后输入焦点的分屏内打开，可以使用 [DMT_EditorControl](./DMT_EditorControl.md) 内的接口获取
...
标签页 ID，对应 [IDMT_EditorTabItem.tabId](../interfaces/IDMT_EditorTabItem.md)<!-- -->，可使用 [DMT_EditorControl.getSplitScreenIdByTabId()](./DMT_EditorControl.md) 获取到分屏 ID
...
Promise&lt;Array&lt;[ILIB_SymbolSearchItem](../interfaces/ILIB_SymbolSearchItem.md)<!-- -->&gt;&gt;
