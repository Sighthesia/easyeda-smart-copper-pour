...
# PCB_PrimitiveLine.create() method
...
Promise&lt;[IPCB_PrimitiveLine](./IPCB_PrimitiveLine.md) \| undefined&gt;

直线图元对象

### delete

# PCB_PrimitiveLine.delete() method
...
string \| [IPCB_PrimitiveLine](./IPCB_PrimitiveLine.md) \| Array&lt;string&gt; \| Array&lt;[IPCB_PrimitiveLine](./IPCB_PrimitiveLine.md)<!-- -->&gt;
...
Promise&lt;Array&lt;[IPCB_PrimitiveLine](./IPCB_PrimitiveLine.md)<!-- -->&gt;&gt;
...
# PCB_PrimitiveLine.getAll() method
...
# PCB_PrimitiveLine.getAllPrimitiveId() method
...
# PCB_PrimitiveLine.modify() method
...
string \| [IPCB_PrimitiveLine](./IPCB_PrimitiveLine.md)
...
{ net?: string; layer?: [TPCB_LayersOfLine](../types/TPCB_LayersOfLine.md)<!-- -->; startX?: number; startY?: number; endX?: number; endY?: number; lineWidth?: number; primitiveLock?: boolean; }
