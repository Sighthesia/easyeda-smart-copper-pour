...
标签页 ID，此处支持 [IDMT_SchematicPageItem.uuid](../interfaces/IDMT_SchematicPageItem.md)<!-- -->、[IDMT_PcbItem.uuid](../interfaces/IDMT_PcbItem.md)<!-- -->、[IDMT_PanelItem.uuid](../interfaces/IDMT_PanelItem.md) 作为输入
...
如若文档尚未保存，执行此操作将会直接丢失所有未保存的数据，请在修改操作完成后首先执行 [SCH_Document.save()](./SCH_Document.md)<!-- -->、[PCB_Document.save()](./PCB_Document.md)<!-- -->、[PNL_Document.save()](./PNL_Document.md) 保存数据
...
[EDMT_EditorSplitScreenDirection](../enums/EDMT_EditorSplitScreenDirection.md)
...
Array&lt;[IDMT_IndicatorMarkerShape](../interfaces/IDMT_IndicatorMarkerShape.md)<!-- -->&gt;
...
Promise&lt;[IDMT_EditorSplitScreenItem](../interfaces/IDMT_EditorSplitScreenItem.md) \| undefined&gt;
...
Promise&lt;Array&lt;[IDMT_EditorTabItem](../interfaces/IDMT_EditorTabItem.md)<!-- -->&gt;&gt;
...
# DMT_EditorControl.moveDocumentToSplitScreen() method
...
文档 UUID，此处支持 [IDMT_SchematicItem.uuid](../interfaces/IDMT_SchematicItem.md)<!-- -->、[IDMT_SchematicPageItem.uuid](../interfaces/IDMT_SchematicPageItem.md)<!-- -->、[IDMT_PcbItem.uuid](../interfaces/IDMT_PcbItem.md)<!-- -->、[IDMT_PanelItem.uuid](../interfaces/IDMT_PanelItem.md) 作为输入
...
_（可选）_ 分屏 ID，即 [DMT_EditorControl.getSplitScreenTree()](./DMT_EditorControl.md) 方法获取到的 [IDMT_EditorSplitScreenItem.id](../interfaces/IDMT_EditorSplitScreenItem.md)
...
库 UUID，可以使用 [LIB_LibrariesList](./LIB_LibrariesList.md) 内的接口获取
...
[ELIB_LibraryType.SYMBOL](../enums/ELIB_LibraryType.md) \| [ELIB_LibraryType.FOOTPRINT](../enums/ELIB_LibraryType.md)
