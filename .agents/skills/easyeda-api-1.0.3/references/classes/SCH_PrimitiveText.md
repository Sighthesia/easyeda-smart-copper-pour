...
Promise&lt;[ISCH_PrimitiveText](./ISCH_PrimitiveText.md) \| undefined&gt;

文本图元对象

### delete

# SCH_PrimitiveText.delete() method
...
string \| [ISCH_PrimitiveText](./ISCH_PrimitiveText.md) \| Array&lt;string&gt; \| Array&lt;[ISCH_PrimitiveText](./ISCH_PrimitiveText.md)<!-- -->&gt;
...
Promise&lt;Array&lt;[ISCH_PrimitiveText](./ISCH_PrimitiveText.md)<!-- -->&gt;&gt;
...
# SCH_PrimitiveText.getAllPrimitiveId() method
...
string \| [ISCH_PrimitiveText](./ISCH_PrimitiveText.md)
...
{ x?: number; y?: number; content?: string; rotation?: number; textColor?: string \| null; fontName?: string \| null; fontSize?: number \| null; bold?: boolean; italic?: boolean; underLine?: boolean; alignMode?: [ESCH_PrimitiveTextAlignMode](../enums/ESCH_PrimitiveTextAlignMode.md)<!-- -->; }
