...
**实现自：**[IPCB_PrimitiveAPI](../interfaces/IPCB_PrimitiveAPI.md)
...
Promise&lt;[IPCB_PrimitivePad](./IPCB_PrimitivePad.md) \| undefined&gt;

焊盘图元对象

### delete

# PCB_PrimitivePad.delete() method
...
string \| [IPCB_PrimitivePad](./IPCB_PrimitivePad.md) \| Array&lt;string&gt; \| Array&lt;[IPCB_PrimitivePad](./IPCB_PrimitivePad.md)<!-- -->&gt;
...
Promise&lt;Array&lt;[IPCB_PrimitivePad](./IPCB_PrimitivePad.md)<!-- -->&gt;&gt;
...
# PCB_PrimitivePad.getAllPrimitiveId() method
...
# PCB_PrimitivePad.modify() method
...
string \| [IPCB_PrimitivePad](./IPCB_PrimitivePad.md)
...
{ layer?: [TPCB_LayersOfPad](../types/TPCB_LayersOfPad.md)<!-- -->; padNumber?: string; x?: number; y?: number; rotation?: number; pad?: [TPCB_PrimitivePadShape](../types/TPCB_PrimitivePadShape.md)<!-- -->; net?: string; hole?: [TPCB_PrimitivePadHole](../types/TPCB_PrimitivePadHole.md) \| null; holeOffsetX?: number; holeOffsetY?: number; holeRotation?: number; metallization?: boolean; specialPad?: [TPCB_PrimitiveSpecialPadShape](../types/TPCB_PrimitiveSpecialPadShape.md)<!-- -->; solderMaskAndPasteMaskExpansion?: [IPCB_PrimitiveSolderMaskAndPasteMaskExpansion](../interfaces/IPCB_PrimitiveSolderMaskAndPasteMaskExpansion.md) \| null; heatWelding?: IPCB_PrimitivePadHeatWelding \| null; primitiveLock?: boolean; }
