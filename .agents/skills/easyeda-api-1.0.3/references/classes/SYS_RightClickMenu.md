...
Array&lt;[ISYS_RightClickMenuItem](../interfaces/ISYS_RightClickMenuItem.md) \| null&gt;
...
如若需要注册新的右键菜单，需要传入完整的 [ISYS_RightClickMenuItem](../interfaces/ISYS_RightClickMenuItem.md) 数据
