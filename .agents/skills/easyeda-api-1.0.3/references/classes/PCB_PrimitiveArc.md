...
# PCB_PrimitiveArc.create() method
...
Promise&lt;[IPCB_PrimitiveArc](./IPCB_PrimitiveArc.md) \| undefined&gt;
...
string \| [IPCB_PrimitiveArc](./IPCB_PrimitiveArc.md) \| Array&lt;string&gt; \| Array&lt;[IPCB_PrimitiveArc](./IPCB_PrimitiveArc.md)<!-- -->&gt;
...
Promise&lt;Array&lt;[IPCB_PrimitiveArc](./IPCB_PrimitiveArc.md)<!-- -->&gt;&gt;
...
string \| [IPCB_PrimitiveArc](./IPCB_PrimitiveArc.md)
...
{ net?: string; layer?: [TPCB_LayersOfLine](../types/TPCB_LayersOfLine.md)<!-- -->; startX?: number; startY?: number; endX?: number; endY?: number; arcAngle?: number; lineWidth?: number; interactiveMode?: [EPCB_PrimitiveArcInteractiveMode](../enums/EPCB_PrimitiveArcInteractiveMode.md)<!-- -->; primitiveLock?: boolean; }
