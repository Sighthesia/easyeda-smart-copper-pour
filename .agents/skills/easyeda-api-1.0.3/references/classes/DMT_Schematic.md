...
Promise&lt;Array&lt;[IDMT_SchematicPageItem](../interfaces/IDMT_SchematicPageItem.md)<!-- -->&gt;&gt;
...
Promise&lt;Array&lt;[IDMT_SchematicItem](../interfaces/IDMT_SchematicItem.md)<!-- -->&gt;&gt;
...
Promise&lt;[IDMT_SchematicItem](../interfaces/IDMT_SchematicItem.md) \| undefined&gt;
...
Promise&lt;[IDMT_SchematicPageItem](../interfaces/IDMT_SchematicPageItem.md) \| undefined&gt;
...
Array&lt;[IDMT_SchematicPageItem](../interfaces/IDMT_SchematicPageItem.md)<!-- -->&gt;
...
此处源原理图图页属性的数组需要通过 [DMT_Schematic.getAllSchematicPagesInfo()](./DMT_Schematic.md) 或其它上游方法取得，完成数组排序后传入
