...
此处所有接口都基于编辑器当前工作区环境，如需切换到其他工作区，请使用 [DMT_Workspace.toggleToWorkspace()](./DMT_Workspace.md) 接口切换工作区
...
# LIB_LibrariesList.getAllLibrariesList() method
...
Promise&lt;Array&lt;[ILIB_LibraryInfo](../interfaces/ILIB_LibraryInfo.md)<!-- -->&gt;&gt;
...
# LIB_LibrariesList.getFavoriteLibraryUuid() method
...
# LIB_LibrariesList.getSystemLibraryUuid() method
